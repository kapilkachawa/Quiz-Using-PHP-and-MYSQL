...
if (!isset($_SESSION['visited'])) {
    // This code will only execute the first time the user accesses the page during the session
    // Add any code you want to execute only once here

    // Set the 'visited' session variable to indicate that the code has been executed
    $_SESSION['visited'] = true;
}

// User is logged in, you can access user-specific data here
$userId = $_SESSION['user_acc'];
// Add other user-related code as needed
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a href="#" class="active">Terms & Condition</a></li>
  ...
  <div class="container">
    ...
    <div class="row content">
      ...
      <div class="col-lg-6 pt-4 pt-lg-0">
        ...
        <ul>
          <li><i class="ri-check-double-line"></i> Explore diverse quizzes to test your expertise.</li>
          <li><i class="ri-check-double-line"></i> Experience timed challenges for added excitement.</li>
          <li><i class="ri-check-double-line"></i> Engage with a community of learners and share knowledge.</li>
        </ul>
        <p class="fst-italic">
    ...
    <div class="row">
        ...
        <div class="col-md-6 mt-4 mt-md-0">
          ...
          <footer id="footer">
            ...
            <div class="container">
                <div class="copyright">
                    &copy; Copyright <strong><span>Your Quiz App Name</span></strong>. All Rights Reserved
                </div>
                <div class="credits">
