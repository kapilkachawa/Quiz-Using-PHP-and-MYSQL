...
?>
<?php
$sql_query = "SELECT * FROM programming_languages";
...
<div class="row" style="width: 100%;margin: 0px;padding: 0px;">
	<div class="col-lg-6 col-md-12 col-12" style="width: 100%;margin: 0px;padding: 0px;">
		<h3 class="p-4 title_name">Quiz LIST In Main Page</h3>
	</div>
	
	<div class="col-lg-6 col-md-12 col-12" style="width: 100%;margin: 0px;padding: 0px;">
		<h3 class="title_name float-right"><a class="btn btn-dark" href="add_quiz_home.php">Create New Quiz</a></h3> 
	</div>
