	...
	$sql = "SELECT * FROM ranking_language";
	...
	<div class="row" style="width: 100%;margin-top:60px; margin-left:0px; padding: 0px;">
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            echo '<a href="ranking.php?quiz=' . $row['quiz_name'] . '" class="btn btn-primary">View\'s Rankings</a>';
            echo '</div></div></div>';
        }
        ?>
